...
public class Ex2 {
    ...
    public static class Ex2Mapper extends Mapper<LongWritable, Text, Text, LongWritable> {
        @Override
    ...
    // Etapa combiner
    // genero - 1 - genero - (1,1,1,1)
    public static class Ex2Combine extends Reducer<Text, LongWritable, Text, LongWritable>{
    ...
    public static class Ex2Reduce extends Reducer<Text, LongWritable, Text, Text> {
        @Override
        protected void reduce(Text key, Iterable<LongWritable> values, Context context) throws IOException, InterruptedException {
            long total = 0;
            for(LongWritable value: values){
